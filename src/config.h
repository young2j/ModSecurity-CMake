/* src/config.h.in.  Generated  by cmake.  */
//-------------- check os -----------------
/* Define if the operating system is AIX */
#define AIX 0

/* Define if the operating system is DRAGONFLY */
#define DRAGONFLY 0
...
//----- check headers(may only HAVE_UNISTD_H be used) ------
...
#define PACKAGE_BUGREPORT "security@modsecurity.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "modsecurity"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "modsecurity"
...
#define PACKAGE_VERSION "modsecurity 3.0"
